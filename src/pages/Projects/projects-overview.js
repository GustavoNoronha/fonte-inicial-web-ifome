...
class ProjectsOverview extends Component {
    constructor() {
        ...
        this.state = {
            ...
            files: [
                { name: "Jovem Dev Landing.Zip", size: "3.25 MB", link: "#" },
                { name: "Jovem Dev Admin.Zip", size: "3.15 MB", link: "#" },
                { name: "Jovem Dev Logo.Zip", size: "2.02 MB", link: "#" },
                                    ...
                                    <CardBody>
                                        <Media>
                                            ...
                                            <Media className="overflow-hidden" body>
                                                <h5 className="text-truncate font-size-15">Jovem Dev Dashboard UI</h5>
