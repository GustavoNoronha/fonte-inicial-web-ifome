                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            <Media className="mb-4">
                                                <img className="d-flex mr-3 rounded-circle avatar-sm" src={avatar2} alt="Jovem Dev" />
                                                <Media body>
                                            ...
                                            <Row>
                                                <Col xl="2" xs="6">
                                                    <Card>
                                                        <img className="card-img-top img-fluid" src={img3} alt="Jovem Dev" />
                                                ...
                                                <Col xl="2" xs="6">
                                                    <Card>
                                                        <img className="card-img-top img-fluid" src={img4} alt="Jovem Dev" />
                                                        <div className="py-2 text-center">
                                                            <Link to="" className="font-weight-medium">Download</Link>
                                                        </div>
                                                    </Card>
