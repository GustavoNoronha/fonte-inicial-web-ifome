                    ...
                    <Container fluid={true}>
                        ...
                        <Row>
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <Row>
                                            <Col md={6}>
                                                <img className="rounded mr-2" alt="Jovem Dev" width="200" src={img4} />
                                            </Col>
                                            <Col md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    <img className="rounded-circle avatar-xl" alt="Jovem Dev" src={avatar4} />
                                                </div>
                                            </Col>
                                        </Row>
                                    </CardBody>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <Row>
                                            <Col md={6}>
                                                <img className="img-thumbnail" alt="Jovem Dev" width="200" src={img3} />
                                            </Col>
                                            <Col md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    <img className="img-thumbnail rounded-circle avatar-xl" alt="Jovem Dev" src={avatar3} />
                                                </div>
                                            </Col>
                                        </Row>
                                    </CardBody>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        <CardTitle>Jovem Devs</CardTitle>
                                        ...
                                        <CardImg className="img-fluid" src={img2} alt="Jovem Dev" />
                                    </CardBody>
                                </Card>
                            </Col>
                                    ...
                                    <CardBody>
                                        ...
                                        <Row>
                                            <Col md={6}>
                                                <Row>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar3} alt="Jovem DevJovem Dev" className="rounded avatar-sm" />
                                                        <CardText className="mt-2 mb-lg-0"><code>.avatar-sm</code></CardText>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar4} alt="Jovem Dev" className="rounded avatar-md" />
                                                        <CardText className="mt-2  mb-lg-0"><code>.avatar-md</code></CardText>
                                                    </Col>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar5} alt="Jovem Dev" className="rounded avatar-lg" />
                                            ...
                                            <Col md={6}>
                                                <Row>
                                                    <Col lg={4}>
                                                        <CardImg src={avatar3} alt="Jovem Dev" className="rounded-circle avatar-sm" />
                                                        <CardText className="mt-2 mb-lg-0"><code>.avatar-sm</code></CardText>
                                                    </Col>
                                                    <Col lg={4}>
                                                    ...
                                                    <Col lg={4}>
                                                        <CardImg src={avatar5} alt="Jovem Dev" className="rounded-circle avatar-lg" />
                                                        <CardText className="mt-2 mb-lg-0"><code>.avatar-lg</code></CardText>
                                                    </Col>
                                                </Row>
                                            </Col>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <div className="media mb-4">
                                            <img className="d-flex mr-3 rounded-circle" src={avatar6} alt="Jovem Dev" height="64" />
                                        ...
                                        <div className="media mb-4">
                                            <img className="d-flex mr-3 rounded-circle" src={avatar2} alt="Jovem Dev" height="64" />
                                            <div className="media-body">
                                                <h5 className="mt-0 font-16">Media heading</h5>
                                                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                                ...
                                                <div className="media mt-3">
                                                    <Link className="d-flex pr-3" to="#">
                                                        <img src={avatar3} alt="Jovem Dev" height="64" className="rounded-circle" />
                                                    </Link>
                                                    <div className="media-body">
                                                        <h5 className="mt-0 font-16">Media heading</h5>
                                                        Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
                                        ...
                                        <div className="media">
                                            ...
                                            <img className="d-flex ml-3 rounded-circle" src={avatar4} alt="Jovem Dev" height="64" />
                                        </div>
                            ...
                            <Col className="col-12">
                                <Card>
                                    <CardBody>
                                        ...
                                        <div className="media mb-4">
                                            <img className="d-flex align-self-start rounded mr-3" src={avatar3} alt="Jovem Dev" height="64" />
                                            <div className="media-body">
                                        ...
                                        <div className="media mb-4">
                                            <img className="d-flex align-self-center rounded mr-3" src={avatar5} alt="Jovem Dev" height="64" />
                                            <div className="media-body">
                                        ...
                                        <div className="media">
                                            <img className="d-flex align-self-end rounded mr-3" src={avatar1} alt="Jovem Dev" height="64" />
                                            <div className="media-body">
