                ...
                <div className="page-content">
                    <Container fluid={true}>
                        ...
                        <Row>
                            <Col mg={6} xl={3}>
                                <Card>
                                    <CardImg top className="img-fluid" src={img1} alt="Jovem Dev" />
                                    <CardBody>
                            ...
                            <Col mg={6} xl={3}>
                                <Card>
                                    <CardImg top className="img-fluid" src={img2} alt="Jovem Dev" />
                                    <CardBody>
                                        <CardTitle className="mt-0">Card title</CardTitle>
                                        <CardText>Some quick example text to build on the card title and make
                                            up the bulk of the card's content.</CardText>
                            ...
                            <Col mg={6} xl={3}>
                                ...
                                <Card>
                                    <CardImg top className="img-fluid" src={img3} alt="Jovem Dev" />
                                    <CardBody>
                                        <CardText>Some quick example text to build on the card title and make
                                            up the bulk of the card's content.</CardText>
                                    </CardBody>
                            ...
                            <Col md={6} xl={3}>
                                <Card>
                                    ...
                                    <CardImg className="img-fluid" src={img4} alt="Jovem Dev" />
                                    <CardBody>
                                        <CardText>Some quick example text to build on the card title and make
                                            up the bulk of the card's content.</CardText>
                                        <Link to="#" className="card-link">Card link</Link>
                        ...
                        <Row>
                            <Col lg={4}>
                                <Card>
                                    <CardImg top className="img-fluid" src={img5} alt="Jovem Dev" />
                                    <CardBody>
                                        <CardTitle className="mt-0">Card title</CardTitle>
                            ...
                            <Col lg={4}>
                                <Card>
                                    ...
                                    <CardImg bottom className="img-fluid" src={img7} alt="Jovem Dev" />
                                </Card>
                            </Col>

                            <Col lg={4}>
                                <Card>
                                    <CardImg className="img-fluid" src={img6} alt="Jovem Dev" />
                                    <CardImgOverlay>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <Row className="no-gutters align-items-center">
                                        ...
                                        <Col md={4}>
                                            <CardImg className="img-fluid" src={img3} alt="Jovem Dev" />
                                        </Col>
                                    </Row>
                                </Card>
                            </Col>
                        ...
                        <Row>
                            <Col className="col-12 mb-4">
                                ...
                                <CardDeck>
                                    <Card>
                                        <CardImg top className="img-fluid" src={img4} alt="Jovem Dev" />
                                        <CardBody>
                                            <CardTitle className="mt-0">Card title</CardTitle>
                                    ...
                                    <Card>
                                        <CardImg top className="img-fluid" src={img6} alt="Jovem Dev" />
                                        <CardBody>
                                            <CardTitle className="mt-0">Card title</CardTitle>
                        ...
                        <Row>
                            <Col sm={12}>
                                ...
                                <CardColumns>
                                    <Card>
                                        <CardImg top src={img3} alt="Jovem Dev" />
                                        <CardBody>
                                    ...
                                    <Card>
                                        <CardImg top src={img5} alt="Jovem Dev" />
                                        <CardBody>
                                            <CardTitle>Card title</CardTitle>
                                            <CardText>This card has supporting text below as a natural lead-in to additional content.</CardText>
                                            <CardText><small className="text-muted">Last updated 3 mins ago</small></CardText>
                                    ...
                                    <Card>
                                        <CardImg top src={img7} alt="Jovem Dev" />
                                    </Card>
